...
def mapcompare_roadtype(data_path,dataset,solution,compute_mode,year,token,up_para):
    ...
    for roadclass in [49,41000,42000,43000,44000,45000,47000,51000,52000,53000,54000]:
        ...
        df.to_csv('../output/'+dataset+'_'+str(year)+'_'+str(roadclass)+'_'+token+'_'+str(up_para)+'_recall.csv', index=False)