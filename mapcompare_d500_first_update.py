...
def mapcompare_d500_first_update(data_path,dataset,solution,compute_mode,year,up_para):
    ...
    df.to_csv('../output_update/'+dataset+'_'+str(year)+'_d500'+'_'+str(up_para)+'.csv', index=False)