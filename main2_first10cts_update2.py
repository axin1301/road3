...
from mapcompare_d500_first_update import *
import glob
import PIL
...
def main():
    print("Hello World")
    #test()
    with open("time_log_first10cts_update2017.txt","w") as log_f:
        ...
        for year in [2017]:
            for up_para in [100,200]:
                ...
                # for county in ['xixiangxian']:
                    ...
                    #     print('True!!!!!!!!!!!!!!!!!!!!!!!!!!')
                    mapcompare_d500_first_update('../temp_output_d500/GraphSamplingToolkit-main_improve3',county, 'xyx', 'LCR', year, up_para)
        ...
        for up_para in [100,200]:
            ...
            df_all.to_csv('validation_statistics_all_first10cts_d500_2017_'+str(up_para)+'.csv', index=False)
